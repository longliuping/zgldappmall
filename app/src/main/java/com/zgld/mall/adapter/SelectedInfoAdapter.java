...
public class SelectedInfoAdapter extends BaseAdapter {
	public interface SelectedInfoAdapterListener {
		/**
		 * 删除
		 * @param attributeId
		 * @param position
		 */
		void deleteInfo(int attributeId,int position);
	}

	Context context;
	List<HishopAttributeValues> listInfo;
	LayoutInflater layoutInflater;
	SelectedInfoAdapterListener callBack;

	public SelectedInfoAdapter(Context context,int attributeId,  List<HishopAttributeValues> listInfo, SelectedInfoAdapterListener callBack) {

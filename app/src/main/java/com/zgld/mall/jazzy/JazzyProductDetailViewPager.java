...
public class JazzyProductDetailViewPager extends ViewPager {
	...
	public JazzyProductDetailViewPager(Context context) {
		this(context, null);
		this.context = context;
	}

	@SuppressWarnings("incomplete-switch")
	public JazzyProductDetailViewPager(Context context, AttributeSet attrs) {
		super(context, attrs);
		this.context = context;
...
//		heightMeasureSpec = MeasureSpec.makeMeasureSpec((d.getHeight() / 2)+150, MeasureSpec.EXACTLY);
		heightMeasureSpec = MeasureSpec.makeMeasureSpec((d.getWidth()), MeasureSpec.EXACTLY);

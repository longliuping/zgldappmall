...
public class TimeTextView extends TextView implements Runnable {
	TimeTextViewListener listener = null;;

	public interface TimeTextViewListener {
		/**
		 * 结束时间
		 */
		void endTime();
	...
	public void setListener(TimeTextViewListener listener) {
	...
	private void ComputeTime() {
		...
		if (listener != null) {
			if (msecond < 0 && mmin < 0 && mhour < 0 && mday < 0) {
				listener.endTime();
			}
		}
	}
